...
lxc_0() {
    local NAME="lxc_0"
    local NFS_SOURCE="172.16.10.2:/mnt/Local/Container/A/lxc"
    local MOUNT_POINT="/mnt/Remote/Servers/srv37510/lxc/0"
    local OPTIONS=""
...
virt_0() {
    local NAME="virt_0"
    local NFS_SOURCE="172.16.10.2:/mnt/Local/Container/A/Virt"
    local MOUNT_POINT="/mnt/Remote/Servers/srv37510/Virt/0"
    local OPTIONS=""
    local MAX_ATTEMPTS=3
    local SLEEP_TIME=60
    local SILENT_FAIL=true
