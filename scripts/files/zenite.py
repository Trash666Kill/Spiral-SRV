...
Uso:
  python zenite.py --list
  python zenite.py --list "Documentos/HS-STG-02"
  python zenite.py --upload /caminho/local/arquivo.txt "Documentos/HS-STG-02/arquivo.txt"
  python zenite.py --upload /caminho/local/arquivo.txt "Documentos/HS-STG-02/"
  python zenite.py --download "Documentos/HS-STG-02/Full/arquivo.tar" /mnt/Local/destino/
  python zenite.py --download "Documentos/HS-STG-02/Full" /mnt/Local/destino/
  python zenite.py --delete "Documentos/HS-STG-02/Full/arquivo.txt"
  python zenite.py --delete "Documentos/HS-STG-02/Full"
  python zenite.py --delete-contents "Documentos/HS-STG-02/Full"
  python zenite.py --sync /mnt/Local/Backup "Documentos/HS-STG-02"
  python zenite.py --sync /mnt/Local/Backup "Documentos/HS-STG-02" --mirror
  python zenite.py --sync /mnt/Local/Backup "Documentos/HS-STG-02" --log-dir /tmp/logs
"""
...
DEFAULT_LOG_DIR = os.getenv("LOG_DIR", "/var/log/zenite")
...
def setup_logging(log_dir: str):
    ...
    Nome do arquivo: zenite_YYYY-MM-DD_HH-MM-SS.log
    """
    try:
    ...
    log_file  = os.path.join(log_dir, f"zenite_{timestamp}.log")
...
def gerar_env():
    ...
    linhas = [
        ...
        "# -------------------------------------------------------",
        "",
        "# Diretorio onde os arquivos de log serao salvos (padrao: /var/log/zenite)",
        "# LOG_DIR=/var/log/zenite",
        "",
...
def main():
    ...
    epilog = "\n".join([
        ...
        "  3. Em Nome, defina como zenite (ou o nome do seu projeto).",
